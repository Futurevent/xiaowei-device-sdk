...
public class WVJBWebViewClient extends WebViewClient {
    ...
    private void dispatchMessage(WVJBMessage message) {
        ...
        executeJavascript("XWJsBridge._handleMessageFromObjC('"
                + messageJSON + "');");
    }
    ...
    private void flushMessageQueue() {
        String script = "XWJsBridge._fetchQueue()";
    ...
    void log(String action, Object json) {
        ...
        if (jsonString.length() > 500) {
            QLog.i(kTag, action + ": " + jsonString.substring(0, 500) + " [...]");
        } else {
            QLog.i(kTag, action + ": " + jsonString);
        }
    }
