...
protected:
  ...
  // 翻译成Media对象
  virtual bool ResToMedia(const TXCA_PARAM_RESOURCE *item, _Out_ PtrMedia &_media, int resource_list_type);
  void InitList(TXCA_PLAYLIST_TYPE list_type, bool is_up, bool has_more);

protected:
  TXCAutoPtr<CSkillControl> control_;
  bool m_is_need_play;
